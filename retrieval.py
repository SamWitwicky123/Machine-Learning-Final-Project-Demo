...
def evaluate_retrieval_with_metadata(model, dataset_vectors, df, sample_size=50, top_k=5):
    """
    ...
    Returns:
        dict: 包含 mrr, recall_at_1, recall_at_5, sample_size
    """
    # 1. 筛选有效的游戏
    eval_df = df[
    ...
    if len(eval_df) == 0:
        return {
            ...
            "recall_at_5": 0.0,
            "sample_size": 0,
            "error": "No valid games with both name and genres"
        }
